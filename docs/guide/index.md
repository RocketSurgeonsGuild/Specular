...
The static property `IIndagoProvider.EntryAssembly` resolves the generated provider for the running entry assembly automatically. See [Quickstart](/guide/quickstart) for usage.
...
- [Installation](/guide/installation) — add Indago to your project in under 5 minutes
