...
This page assumes you have already [installed Indago](/guide/installation) and applied `[assembly: IndagoProviderAttribute]` to your entry project.
...
- [AOT Publishing](/guide/aot-publishing) — publish with Native AOT and zero trim warnings
