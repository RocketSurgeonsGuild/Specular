...
export default defineSquad({
    team: defineTeam({
        ...
        agents: [
            ...
            defineAgent({
                ...
                status: "active",
                capabilities: [
                    { name: "ISpecularProvider API design", level: "expert" },
    ...
    routing: defineRouting({
        ...
        rules: [
            {
                pattern: /\bIIncrementalGenerator|syntax provider|symbol visitor|AssemblyProvider|ctpjson|SpecularProviderGenerator\b/i,
            ...
            {
                pattern: /\bISpecularProvider|ServiceRegistration|ExcludeFromSpecular|AddSpecular\b/i,
