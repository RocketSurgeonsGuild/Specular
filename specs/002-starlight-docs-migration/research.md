...
**Integration point**: Run `xmldocmd src/Specular/bin/Release/net8.0/Specular.dll docs/src/content/docs/api/` after `dotnet build -c Release`. Wire into `mise run docs:api` task.
...
TYPESENSE_COLLECTION_NAME=specular-docs
```
...
docs/reference/exclude-from-specular.md
docs/reference/ispecular-provider.md
...
| Reference       | reference/ispecular-provider, reference/type-filters, reference/service-registration, reference/exclude-from-specular |
