...
export default defineConfig({
    ...
    lang: 'en-US',
    base: '/Specular/', // MUST match GitHub Pages project-site URL prefix
    ...
    themeConfig: {
        ...
        nav: [
            ...
            { text: 'Reference', link: '/reference/ispecular-provider' },
            { text: 'Architecture', link: '/architecture/how-it-works' },
            { text: 'GitHub', link: 'https://github.com/RocketSurgeonsGuild/Specular', rel: 'external' },
        ],
        ...
        // Edit link (required)
        editLink: {
            pattern: 'https://github.com/RocketSurgeonsGuild/Specular/edit/main/docs/:path',
            text: 'Edit this page on GitHub',
        },

        // Social links (required)
        socialLinks: [{ icon: 'github', link: 'https://github.com/RocketSurgeonsGuild/Specular' }],
