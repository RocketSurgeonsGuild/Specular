...
// Indago.Samples.Console — proves compile-time scanning of the three sample libraries end-to-end.
//
// The host performs Indago's COMPILE-TIME scanning (no runtime reflection): each provider.Scan call
// below is resolved by the source generator at build time into a concrete IIndagoProvider. We read
...
// Also exercise IIndagoProvider.EntryAssembly type discovery (US2 AC3): the entry assembly defines
...
Console.WriteLine($"Indago discovered {actual.Count} service(s) across 3 libraries:");
