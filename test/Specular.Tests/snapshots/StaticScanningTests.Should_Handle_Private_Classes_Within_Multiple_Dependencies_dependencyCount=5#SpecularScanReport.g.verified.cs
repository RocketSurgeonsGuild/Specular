...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("Dependency0Project", "Dependency1Project.Service0", "typeof(Dependency1Project.Service0)"), new("Dependency1Project", "Dependency1Project.Service1", "typeof(Dependency1Project.Service1)"), new("Dependency2Project", "Dependency1Project.Service2", "typeof(Dependency1Project.Service2)"), new("Dependency3Project", "Dependency1Project.Service3", "typeof(Dependency1Project.Service3)"), new("Dependency4Project", "Dependency1Project.Service4", "typeof(Dependency1Project.Service4)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:16] --> E0{ServiceDescriptor}
    E0 --> E0T0[Dependency1Project.Service0]
    E0 --> E0T1[Dependency1Project.Service1]
    E0 --> E0T2[Dependency1Project.Service2]
    E0 --> E0T3[Dependency1Project.Service3]
    E0 --> E0T4[Dependency1Project.Service4]
";
}
#nullable restore
