...
internal sealed class SpecularScanReport
{
    ...
    , 
        [
            new("TestProject", "z => z.DependenciesFromAssemblyOf<ServiceA>().AddClasses(x => x.AssignableTo(typeof(IService)), true).AsSelf().AsImplementedInterfaces().WithSingletonLifetime()", 
                [
