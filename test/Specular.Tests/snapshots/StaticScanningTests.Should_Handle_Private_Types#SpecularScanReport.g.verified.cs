...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("RootDependencyProject", "RootDependencyProject.Service", "typeof(RootDependencyProject.Service)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:16] --> E0{ServiceDescriptor}
    E0 --> E0T0[RootDependencyProject.Service]
";
}
#nullable restore
