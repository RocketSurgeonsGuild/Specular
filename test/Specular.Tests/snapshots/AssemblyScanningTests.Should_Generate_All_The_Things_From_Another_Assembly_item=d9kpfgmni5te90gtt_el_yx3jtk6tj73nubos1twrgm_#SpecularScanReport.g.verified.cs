...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.Reflection, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("OtherProject", "Specular.SpecularScanReport", ""), new("Specular", "Specular.SpecularProviderServiceCollectionExtensions", "typeof(Specular.SpecularProviderServiceCollectionExtensions)"), new("Specular", "Specular.SpecularScanReport", ""), new("Specular", "Specular.SpecularSupport", "typeof(Specular.SpecularSupport)"), new("TestAssembly", "TestAssembly.Nested", "typeof(TestAssembly.Nested)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:16] --> E0{Reflection}
    E0 --> E0T0[Specular.SpecularScanReport]
    E0 --> E0T1[Specular.SpecularProviderServiceCollectionExtensions]
    E0 --> E0T2[Specular.SpecularScanReport]
    E0 --> E0T3[Specular.SpecularSupport]
    E0 --> E0T4[TestAssembly.Nested]
";
}
#nullable restore
