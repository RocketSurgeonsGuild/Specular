...
internal sealed class SpecularScanReport
{
    ...
    , 
        [
            new("TestProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo(typeof(IService)).AssignableTo<IServiceB>().Contains(nameof(Factory))).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestProject", 
                        [
                            new(ServiceLifetime.Scoped, "global::IService", "global::ServFactoryice"), 
                            new(ServiceLifetime.Scoped, "global::IServiceB", "global::ServFactoryice"), 
                            new(ServiceLifetime.Scoped, "global::ServFactoryice", "global::ServFactoryice")]
                    )]
            )]
    );
}