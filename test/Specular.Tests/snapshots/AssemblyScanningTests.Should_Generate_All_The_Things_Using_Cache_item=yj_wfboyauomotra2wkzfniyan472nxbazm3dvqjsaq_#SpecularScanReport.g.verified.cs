...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.Reflection, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("Specular", "Specular.Abstractions.TypeInfoFilter", "typeof(Specular.Abstractions.TypeInfoFilter)"), new("Specular", "Specular.Abstractions.TypeKindFilter", "typeof(Specular.Abstractions.TypeKindFilter)"), new("Specular", "Specular.ScannerExpressionKind", "") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:16] --> E0{Reflection}
    E0 --> E0T0[Specular.Abstractions.TypeInfoFilter]
    E0 --> E0T1[Specular.Abstractions.TypeKindFilter]
    E0 --> E0T2[Specular.ScannerExpressionKind]
";
}
#nullable restore
