...
internal sealed class SpecularScanReport
{
    ...
    , 
        [
            new("TestProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo(typeof(IService)).AssignableTo<IServiceB>().StartsWith(nameof(Factory))).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestProject", 
                        [
                            new(ServiceLifetime.Scoped, "global::FactoryService", "global::FactoryService"), 
                            new(ServiceLifetime.Scoped, "global::IService", "global::FactoryService"), 
                            new(ServiceLifetime.Scoped, "global::IServiceB", "global::FactoryService")]
                    )]
            )]
    );
}