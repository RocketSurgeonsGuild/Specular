...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 33, new ScanReportAssembly[] { }, new ScanReportType[] { new("TestProject", "TestProject.A.Nested+ServiceA", "typeof(TestProject.A.Nested.ServiceA)"), new("TestProject", "TestProject.A.Service", "typeof(TestProject.A.Service)") }),
    };
