...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("Dependency0Project", "Dependency1Project.Service0", "typeof(Dependency1Project.Service0)"), new("Dependency1Project", "Dependency1Project.Service1", "typeof(Dependency1Project.Service1)"), new("Dependency2Project", "Dependency1Project.Service2", "typeof(Dependency1Project.Service2)"), new("Dependency3Project", "Dependency1Project.Service3", "typeof(Dependency1Project.Service3)") }),
    };
