...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("Dependency0Project", "Dependency1Project.RequestHandler0", "typeof(Dependency1Project.RequestHandler0)"), new("Dependency1Project", "Dependency1Project.RequestHandler1", "typeof(Dependency1Project.RequestHandler1)") }),
    };
