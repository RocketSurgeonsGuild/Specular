...
internal sealed class SpecularScanReport
{
    ...
    , 
        [
            new("TestProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo(typeof(IService<>))).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("RootDependencyProject", 
                        [
                            new(ServiceLifetime.Scoped, "global::RootDependencyProject.IService<>", "global::RootDependencyProject.Service<>"), 
                            new(ServiceLifetime.Scoped, "global::RootDependencyProject.Service<>", "global::RootDependencyProject.Service<>")]
                    )]
            )]
    );
}