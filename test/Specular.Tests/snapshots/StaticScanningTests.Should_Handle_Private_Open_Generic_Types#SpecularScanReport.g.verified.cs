...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 13, new ScanReportAssembly[] { }, new ScanReportType[] { new("RootDependencyProject", "RootDependencyProject.Service`1", "typeof(RootDependencyProject.Service<T>)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:13] --> E0{ServiceDescriptor}
    E0 --> E0T0[RootDependencyProject.Service`1]
";
}
#nullable restore
