...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 33, new ScanReportAssembly[] { }, new ScanReportType[] { new("TestProject", "TestProject.A.C.ServiceC", "typeof(TestProject.A.C.ServiceC)"), new("TestProject", "TestProject.A.Nested+ServiceA", "typeof(TestProject.A.Nested.ServiceA)"), new("TestProject", "TestProject.A.Service", "typeof(TestProject.A.Service)"), new("TestProject", "TestProject.B.ServiceB", "typeof(TestProject.B.ServiceB)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:33] --> E0{ServiceDescriptor}
    E0 --> E0T0[TestProject.A.C.ServiceC]
    E0 --> E0T1[TestProject.A.Nested+ServiceA]
    E0 --> E0T2[TestProject.A.Service]
    E0 --> E0T3[TestProject.B.ServiceB]
";
}
#nullable restore
