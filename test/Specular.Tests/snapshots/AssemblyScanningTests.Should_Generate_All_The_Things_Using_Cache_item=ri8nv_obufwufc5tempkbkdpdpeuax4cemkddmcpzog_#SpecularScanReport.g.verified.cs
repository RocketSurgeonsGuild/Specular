...
internal static class SpecularScanReport
{
    ...
    E0 --> E0T0[Specular.Abstractions.ExcludeFromSpecularAttribute]
    E0 --> E0T1[Specular.Abstractions.IReflectionAssemblySelector]
    E0 --> E0T2[Specular.Abstractions.IReflectionTypeSelector]
    E0 --> E0T3[Specular.Abstractions.IServiceDescriptorAssemblySelector]
    E0 --> E0T4[Specular.Abstractions.IServiceDescriptorTypeSelector]
    E0 --> E0T5[Specular.Abstractions.IServiceLifetimeSelector]
    E0 --> E0T6[Specular.Abstractions.IServiceTypeSelector]
    E0 --> E0T7[Specular.Abstractions.ITypeFilter]
    E0 --> E0T8[Specular.Abstractions.SpecularHashAttribute]
    E0 --> E0T9[Specular.Abstractions.TypeInfoFilter]
    E0 --> E0T10[Specular.Abstractions.TypeKindFilter]
    E0 --> E0T11[Specular.RegistrationLifetimeAttribute]
    E0 --> E0T12[Specular.ServiceRegistrationAttribute]
    ...
    E0 --> E0T21[Specular.SpecularProviderServiceCollectionExtensions]
    E0 --> E0T22[Specular.SpecularSupport]
    E0 --> E0T23[TestAssembly.GenericServiceB]
    E0 --> E0T24[TestAssembly.IGenericService`1]
    E0 --> E0T25[TestAssembly.IOther]
    E0 --> E0T26[TestAssembly.IRequestHandler`2]
    E0 --> E0T27[TestAssembly.IRequest`1]
    E0 --> E0T28[TestAssembly.IService]
    E0 --> E0T29[TestAssembly.IServiceB]
    E0 --> E0T30[TestAssembly.IValidator]
    E0 --> E0T31[TestAssembly.IValidator`1]
    E0 --> E0T32[TestAssembly.Nested]
    E0 --> E0T33[TestAssembly.Nested+GenericServiceA]
    E0 --> E0T34[TestAssembly.Nested+ServiceA]
    E0 --> E0T35[TestAssembly.Service]
";
}
#nullable restore
