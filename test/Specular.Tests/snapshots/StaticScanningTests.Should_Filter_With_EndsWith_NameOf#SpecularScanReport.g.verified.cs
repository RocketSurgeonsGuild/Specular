...
internal sealed class SpecularScanReport
{
    ...
    , 
        [
            new("TestProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo(typeof(IService)).AssignableTo<IServiceB>().EndsWith(nameof(Factory))).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestProject", 
                        [
                            new(ServiceLifetime.Scoped, "global::IService", "global::ServiceFactory"), 
                            new(ServiceLifetime.Scoped, "global::IServiceB", "global::ServiceFactory"), 
                            new(ServiceLifetime.Scoped, "global::ServiceFactory", "global::ServiceFactory")]
                    )]
            )]
    );
}