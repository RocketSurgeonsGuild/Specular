...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("TestAssembly", "TestAssembly.Nested+ServiceA", "typeof(TestAssembly.Nested.ServiceA)"), new("TestAssembly", "TestAssembly.Service", "typeof(TestAssembly.Service)"), new("TestAssembly", "TestAssembly.ServiceB", "typeof(TestAssembly.ServiceB)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:16] --> E0{ServiceDescriptor}
    E0 --> E0T0[TestAssembly.Nested+ServiceA]
    E0 --> E0T1[TestAssembly.Service]
    E0 --> E0T2[TestAssembly.ServiceB]
";
}
#nullable restore
