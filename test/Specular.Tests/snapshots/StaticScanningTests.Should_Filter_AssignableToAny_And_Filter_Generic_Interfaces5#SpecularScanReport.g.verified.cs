...
internal sealed class SpecularScanReport
{
    ...
    , 
        [
            new("TestProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableToAny(typeof(IValidator))).AsSelf().AsImplementedInterfaces(z => z.AssignableTo(typeof(IValidator<>))).WithScopedLifetime()", 
                [
                    new("TestProject", 
                        [
                            new(ServiceLifetime.Scoped, "global::IValidator<global::Nested+MyRecord>", "global::Nested+Validator"), 
                            new(ServiceLifetime.Scoped, "global::Nested+Validator", "global::Nested+Validator")]
                    )]
            )]
    );
}