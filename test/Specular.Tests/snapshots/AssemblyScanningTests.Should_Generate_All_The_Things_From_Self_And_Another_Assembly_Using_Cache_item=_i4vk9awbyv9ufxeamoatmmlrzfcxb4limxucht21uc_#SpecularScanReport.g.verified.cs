...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("TestAssembly", "TestAssembly.Nested+Validator", "typeof(TestAssembly.Nested.Validator)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:16] --> E0{ServiceDescriptor}
    E0 --> E0T0[TestAssembly.Nested+Validator]
";
}
#nullable restore
