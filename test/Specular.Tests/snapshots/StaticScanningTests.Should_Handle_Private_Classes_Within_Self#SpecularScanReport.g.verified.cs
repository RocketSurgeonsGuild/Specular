            ...
            new("TestProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo<IService>()).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("DependencyProject", 
                        [
                            new(ServiceLifetime.Scoped, "global::DependencyProject.IService", "global::DependencyProject.Service"), 
                            new(ServiceLifetime.Scoped, "global::DependencyProject.Service", "global::DependencyProject.Service")]
                    ), 
                    new("TestProject", 
                        [
                            new(ServiceLifetime.Scoped, "global::DependencyProject.IService", "global::TestProject.Service"), 
                            new(ServiceLifetime.Scoped, "global::TestProject.Service", "global::TestProject.Service")]
                    )]
            )]
    );
}