...
internal sealed class SpecularScanReport
{
    public static ScanResults GetScanResults() => new(
        [
            ...
            new("OtherProject", "z => z.FromAssemblies()", 
                [
                    new("OtherProject"), 
                    new("Specular"), 
                    new("System.Collections.Immutable"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().IncludeSystemAssemblies()", 
                [
                    new("OtherProject"), 
                    new("Specular"), 
                    new("System"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>()", 
                [
                    new("OtherProject"), 
                    new("System.Collections.Immutable"), 
                    new("System.ComponentModel"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<IService>()", 
                [
                    new("OtherProject"), 
                    new("Specular"), 
                    new("System.Collections.Immutable"), 
            ...
            new("OtherProject", "z => z.EntryAssembly()", 
                [
                    new("OtherProject")]
            ), 
            ...
            new("OtherProject", "z => z.DependenciesFromAssemblyOf<ServiceRegistrationAttribute>()", 
                [
                    new("OtherProject"), 
                    new("TestAssembly"), 
                    new("TestProject")]
            ...
            new("OtherProject", "z => z.DependenciesFromAssemblyOf<IService>()", 
                [
                    new("OtherProject"), 
                    new("TestProject")]
            )]
    , 
        [
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().NotKindOf(TypeKindFilter.Delegate, TypeKindFilter.Class).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("TestAssembly", 
                        [
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().InfoOf(TypeInfoFilter.Abstract).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("TestAssembly", 
                        [
                            new("global::TestAssembly.IGenericService<>"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().InfoOf(TypeInfoFilter.Visible).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("TestAssembly", 
                        [
                            new("global::TestAssembly.GenericServiceB"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().InfoOf(TypeInfoFilter.Sealed).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("OtherProject", 
                        [
                            new("global::Microsoft.CodeAnalysis.EmbeddedAttribute"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().NotInfoOf(TypeInfoFilter.Static).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("OtherProject", 
                        [
                            new("global::Microsoft.CodeAnalysis.EmbeddedAttribute"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().InfoOf(TypeInfoFilter.GenericType).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("TestAssembly", 
                        [
                            new("global::TestAssembly.IGenericService<>"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().NotInfoOf(TypeInfoFilter.Abstract).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("OtherProject", 
                        [
                            new("global::Microsoft.CodeAnalysis.EmbeddedAttribute"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().NotInfoOf(TypeInfoFilter.Visible).NotAssignableTo<Attribute>().NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("OtherProject", 
                        [
                            new("global::Program"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().DependenciesFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.WithAnyAttribute(typeof(ServiceRegistrationAttribute)))", 
                [
                    new("TestAssembly", 
                        [
                            new("global::TestAssembly.GenericService"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().NotInfoOf(TypeInfoFilter.ValueType).NotAssignableTo<Attribute>().NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("OtherProject", 
                        [
                            new("global::Program"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().NotInfoOf(TypeInfoFilter.Sealed).NotAssignableTo<Attribute>().NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("OtherProject", 
                        [
                            new("global::Program")]
            ...
            new("OtherProject", "z => z.FromAssemblies().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().WithAttribute(typeof(EditorBrowsableAttribute)).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("Specular", 
                        [
                            new("global::Specular.SpecularSupport")]
            ...
            new("OtherProject", "z => z.FromAssemblies().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().WithAttribute<EditorBrowsableAttribute>().NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("Specular", 
                        [
                            new("global::Specular.SpecularSupport")]
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().WithoutAttribute(typeof(EditorBrowsableAttribute)).NotAssignableTo(typeof(Attribute)).NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("OtherProject", 
                        [
                            new("global::Program"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(x => x.NotAssignableTo<ISpecularProvider>().WithoutAttribute<EditorBrowsableAttribute>().NotAssignableTo<Attribute>().NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("OtherProject", 
                        [
                            new("global::Program"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().NotFromAssemblyOf<ServiceRegistrationAttribute>().GetTypes(true, x => x.NotAssignableTo<ISpecularProvider>().NotInNamespaces(\"JetBrains.Annotations\", \"Polyfills\", \"System\").NotStartsWith(\"Polyfill\"))", 
                [
                    new("TestAssembly", 
                        [
                            new("global::TestAssembly.GenericServiceB"), 
    ...
    , 
        [
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo<IServiceB>(), false).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo<IService>(), false).AsSelf().AsImplementedInterfaces().WithSingletonLifetime()", 
                [
                    new("TestAssembly", 
                        [
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo<IService>()).As<IService>().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        []
                    )]
            ), 
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo<IService>()).AsSelf().AsImplementedInterfaces().WithSingletonLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Singleton, "global::TestAssembly.IService", "global::TestAssembly.Nested+ServiceA"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo<IService>()).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo(typeof(IGenericService<>))).AsSelfWithInterfaces().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo(typeof(IGenericService<>))).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Scoped, "global::TestAssembly.GenericService", "global::TestAssembly.GenericService"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo(typeof(IRequestHandler<, >))).AsImplementedInterfaces().WithSingletonLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Singleton, "global::TestAssembly.IRequestHandler<global::TestAssembly.Request,global::TestAssembly.Response>", "global::TestAssembly.RequestHandler"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo<IService>().AssignableTo<IServiceB>()).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Scoped, "global::TestAssembly.IService", "global::TestAssembly.Service"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableToAny(typeof(IService), typeof(IServiceB))).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Scoped, "global::TestAssembly.IService", "global::TestAssembly.Nested+ServiceA"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableToAny(typeof(IService), typeof(IServiceB))).AsSelf().AsImplementedInterfaces(z => z.AssignableTo<IServiceB>()).WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Scoped, "global::TestAssembly.IServiceB", "global::TestAssembly.Service"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableToAny(typeof(IOther))).AsSelf().AsImplementedInterfaces(z => z.AssignableTo(typeof(IGenericService<>))).WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Scoped, "global::TestAssembly.GenericService", "global::TestAssembly.GenericService"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableToAny(typeof(IValidator))).AsImplementedInterfaces(z => z.AssignableTo(typeof(IValidator<>))).WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableToAny(typeof(IService))).As<IService>().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        []
                    )]
            ), 
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableToAny(typeof(IOther))).AsSelf().As(typeof(IGenericService<>)).WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Scoped, "global::TestAssembly.GenericService", "global::TestAssembly.GenericService"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableToAny(typeof(IOther))).As(typeof(IGenericService<>)).WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Scoped, "global::TestAssembly.GenericService", "global::TestAssembly.GenericService"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(f => f.WithAnyAttribute(typeof(ServiceRegistrationAttribute), typeof(ServiceRegistrationAttribute<, >), typeof(ServiceRegistrationAttribute<,, >), typeof(ServiceRegistrationAttribute<,, >), typeof(ServiceRegistrationAttribute<,,, >), typeof(ServiceRegistrationAttribute<,,,, >), typeof(ServiceRegistrationAttribute<,,,,, >), typeof(ServiceRegistrationAttribute<,,,,,, >), typeof(ServiceRegistrationAttribute<,,,,,,, >))).AsSelf().WithSingletonLifetime()", 
                [
                    new("TestAssembly", 
                        [
                            new(ServiceLifetime.Singleton, "global::TestAssembly.GenericService", "global::TestAssembly.GenericService"), 
            ...
            new("OtherProject", "z => z.FromAssemblies().AddClasses(x => x.InNamespaces(\"TestAssembly\")).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestAssembly", 
                        [
