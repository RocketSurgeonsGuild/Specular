...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 21, new ScanReportAssembly[] { }, new ScanReportType[] { new("DependencyProjectC", "DependencyProjectC.HardReferenceA", "typeof(DependencyProjectC.HardReferenceA)"), new("DependencyProjectC", "DependencyProjectC.ServiceC", "typeof(DependencyProjectC.ServiceC)"), new("DependencyProjectD", "DependencyProjectD.HardReferenceA", "typeof(DependencyProjectD.HardReferenceA)"), new("DependencyProjectD", "DependencyProjectD.HardReferenceC", "typeof(DependencyProjectD.HardReferenceC)"), new("DependencyProjectD", "DependencyProjectD.ServiceD", "typeof(DependencyProjectD.ServiceD)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:21] --> E0{ServiceDescriptor}
    E0 --> E0T0[DependencyProjectC.HardReferenceA]
    E0 --> E0T1[DependencyProjectC.ServiceC]
    E0 --> E0T2[DependencyProjectD.HardReferenceA]
    E0 --> E0T3[DependencyProjectD.HardReferenceC]
    E0 --> E0T4[DependencyProjectD.ServiceD]
";
}
#nullable restore
