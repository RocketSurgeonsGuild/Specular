            ...
            new("TestProject", "z => z.FromAssemblies().AddClasses(x => x.AssignableTo(typeof(IRequestHandler<, >))).AsImplementedInterfaces().WithSingletonLifetime()", 
                [
                    ...
                    new("Dependency3Project", 
                        [
                            new(ServiceLifetime.Singleton, "global::RootDependencyProject.IRequestHandler<global::Dependency1Project.Request3,global::Dependency1Project.Response3>", "global::Dependency1Project.RequestHandler3")]
                    ), 
                    new("Dependency4Project", 
                        [
                            new(ServiceLifetime.Singleton, "global::RootDependencyProject.IRequestHandler<global::Dependency1Project.Request4,global::Dependency1Project.Response4>", "global::Dependency1Project.RequestHandler4")]
                    )]
            )]
    );
}