...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.Reflection, "Input0.cs", 12, new ScanReportAssembly[] { }, new ScanReportType[] { new("SecretLibrary", "SecretLib.ISecret", "typeof(SecretLib.ISecret)"), new("SecretLibrary", "SecretLib.SecretService", "typeof(SecretLib.SecretService)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:12] --> E0{Reflection}
    E0 --> E0T0[SecretLib.ISecret]
    E0 --> E0T1[SecretLib.SecretService]
";
}
#nullable restore
