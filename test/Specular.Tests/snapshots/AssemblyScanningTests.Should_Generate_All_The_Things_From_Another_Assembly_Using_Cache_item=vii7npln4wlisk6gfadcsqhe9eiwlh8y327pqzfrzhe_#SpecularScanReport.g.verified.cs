...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.Reflection, "Input0.cs", 16, new ScanReportAssembly[] { }, new ScanReportType[] { new("Specular", "Specular.SpecularSupport", "typeof(Specular.SpecularSupport)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:16] --> E0{Reflection}
    E0 --> E0T0[Specular.SpecularSupport]
";
}
#nullable restore
