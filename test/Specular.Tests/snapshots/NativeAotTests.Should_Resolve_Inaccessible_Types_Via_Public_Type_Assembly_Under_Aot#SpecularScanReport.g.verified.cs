...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.ServiceDescriptor, "Input0.cs", 12, new ScanReportAssembly[] { }, new ScanReportType[] { new("AotLibrary", "AotLib.InternalThing", "typeof(AotLib.InternalThing)"), new("AotLibrary", "AotLib.PublicThing", "typeof(AotLib.PublicThing)") }),
    };

    public const string MermaidDiagram = @"flowchart TD
    F0[Input0.cs:12] --> E0{ServiceDescriptor}
    E0 --> E0T0[AotLib.InternalThing]
    E0 --> E0T1[AotLib.PublicThing]
";
}
#nullable restore
