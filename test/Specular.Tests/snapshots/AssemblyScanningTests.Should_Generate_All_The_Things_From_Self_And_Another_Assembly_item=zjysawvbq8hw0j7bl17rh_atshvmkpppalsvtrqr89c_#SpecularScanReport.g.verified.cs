...
internal static class SpecularScanReport
{
    ...
    E0 --> E0T3[TestAssembly.Nested+MyRecord]
    E0 --> E0T4[TestAssembly.Nested+ServiceA]
    E0 --> E0T5[TestAssembly.Nested+Validator]
    E0 --> E0T6[TestAssembly.Request]
    E0 --> E0T7[TestAssembly.RequestHandler]
    E0 --> E0T8[TestAssembly.Response]
    E0 --> E0T9[TestAssembly.Service]
    E0 --> E0T10[TestAssembly.ServiceB]
";
}
#nullable restore
