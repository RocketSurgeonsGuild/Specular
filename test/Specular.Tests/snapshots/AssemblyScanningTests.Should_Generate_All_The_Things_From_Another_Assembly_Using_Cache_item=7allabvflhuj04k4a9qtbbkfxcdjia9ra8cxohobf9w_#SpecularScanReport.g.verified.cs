...
internal static class SpecularScanReport
{
    ...
    {
        new(ScannerExpressionKind.Assembly, "Input0.cs", 16, "z => z.DependenciesFromAssemblyOf<ServiceRegistrationAttribute>()", new ScanReportAssembly[] { new("OtherProject", null), new("TestProject", null) }, new ScanReportType[] { }),
    };
