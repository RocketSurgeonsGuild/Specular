...
internal sealed class SpecularScanReport
{
    ...
    , 
        [
            new("TestProject", "z => z.FromAssemblies().AddClasses(x => x.InNamespaces(\"TestProject\").NotInNamespaceOf(typeof(TestProject.A.C.ServiceC), typeof(TestProject.B.ServiceB))).AsSelf().AsImplementedInterfaces().WithScopedLifetime()", 
                [
                    new("TestProject", 
                        [
