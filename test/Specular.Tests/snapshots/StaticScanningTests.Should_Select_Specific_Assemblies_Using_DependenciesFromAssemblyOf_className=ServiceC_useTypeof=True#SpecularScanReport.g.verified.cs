...
internal sealed class SpecularScanReport
{
    ...
    , 
        [
            new("TestProject", "z => z.DependenciesFromAssemblyOf(typeof(ServiceC)).AddClasses(x => x.AssignableTo(typeof(IService)), true).AsSelf().AsImplementedInterfaces().WithSingletonLifetime()", 
                [
